...
app.directive('historyPopover', ['$http', '$log', function($http, $log) {
    return {
        ...
        */
        ...
        '      class="glyphicon glyphicon-list glyph-button" aria-hidden="true" uib-tooltip="Task History" tooltip-trigger="mouseenter" tooltip-placement="bottom" tooltip-append-to-body="true">' +
        '</span>',
        /**
